...
![](images/02a-squirrel-commitment-v2.png){width=40% fig-align="center" fig-alt="A paperback-style pen-and-ink squirrel in a checked hat and waistcoat doing a Single Ladies dance pose, holding up a sparkling ring and pointing to it."}
...
\int_{\mathcal A_2}
dF_{X_2\mid P_2=p_2}(x_2)
\cdots\\
&\qquad\quad{}
\int_{\mathcal A_K}
dF_{X_K\mid P_K=p_K}(x_K).
\end{aligned}
$$
