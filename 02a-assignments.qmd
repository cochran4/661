...
Return to the wildfire-smoke and asthma model. We write its assignments as
...
The probability of unhealthy smoke is $0.5$. The probability of staying indoors is $0.4$ without unhealthy smoke and $0.6$ with unhealthy smoke. The probability of an asthma exacerbation increases with unhealthy smoke and decreases when the person stays indoors. These probabilities are invented for our example rather than estimated from a particular study.
