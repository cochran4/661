...
An assignment tells us how one variable gets its value, possibly using the values of other variables. We will be careful not to treat assignments as ordinary equations. An assignment is a procedure. We use a left arrow, $\leftarrow$, to be very clear about this point. The procedure takes whatever appears on the right and places it into the variable on the left. For example, the assignment
