...
::: {.example-intro}
<span class="example-label">Example: Which value of $x$?</span>
...
::: {.example-intro}
<span class="example-label">Example: Unclear medication schedule</span>
...
::: {.example-intro}
<span class="example-label">Example: Grace periods</span>
...
::: {.example-intro}
<span class="example-label">Example: Interference</span>
